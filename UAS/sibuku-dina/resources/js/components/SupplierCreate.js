...
class SupplierCreate extends Component {
    ...
    constructor(props) {
        ...
        this.handleCreateNewSupplier = this.handleCreateNewSupplier.bind(this)
    ...
    handleCreateNewSupplier(event) {
        ...
        axios.post('/api/supplier/store', supplier).then(response => {
        ...
        return (
            <div>
                <div style={{ backgroundColor: '#F08080' }}>
                    <br></br>
                    <center><h2>Form Tambah Supplier</h2></center>
                    <hr></hr><br></br>
                            ...
                            <div className='col-md-6'>
                                <div className='card'>
                                    ...
                                    <div className='card-body' style={{ backgroundColor: '#E6E6FA' }} >
                                        <form onSubmit={this.handleCreateNewSupplier}>
