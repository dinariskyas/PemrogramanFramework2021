  ...
  return <form onSubmit={handleSubmit} className="form">
    <div className="field">
      <div className="control">
        <b><Field name="firstName" component={renderField} type="text" label="First Name" /></b>
      </div>
    </div>
    <div className="field">
      <div className="control">
        <b><Field name="lastName" component={renderField} type="text" label="Last Name" /></b>
      </div>
    </div>
    <div className="field">
      <div className="control">
        <b><Field name="email" component={renderField} type="email" label="Email Address" /></b>
      </div>
    </div>
    <div className="field">
      <div className="control">
        <b><Field name="age" component={renderField} type="number" label="Age" /></b>
      </div>
    </div>
    <div className="field">
      <div className="control">
    ...
    return (
      <div className="App">
        ...
        <div className="container">
          <b><p className="App-intro">Contact Form</p></b>
